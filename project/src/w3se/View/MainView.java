...
public class MainView extends JFrame implements Observer
{
	...
	public MainView()
	{
		...
		addWindowListener(m_controller.getListener("exit"));
		...
		m_subLevelManagePane.addTab("Sell", new SellManagePanel(m_conFac.createController(ControllerFactory.SEARCH)));
		...
		m_topLevelPane.addChangeListener(m_controller.getListener("tab_change"));
